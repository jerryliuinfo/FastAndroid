...
public class RankingList extends Base {
    ...
    public List<MaleBean> female = new ArrayList<>();
    /**
    ...
    public ArrayList<MaleBean> male = new ArrayList<>();

    public static class MaleBean implements Serializable, IPagingAdapter.ItemTypeData{
        public String _id;
        public String title;
        public String cover;
        ...
        public String toString() {
            return "MaleBean{" + "_id='" + _id + '\'' + ", title='" + title + '\'' + ", cover='" + cover + '\'' + ", " +
                    "collapse=" + collapse + ", monthRank='" + monthRank + '\'' + ", totalRank='" + totalRank + '\'' + '}';
        }
    ...
    @Override
    public String toString() {
        return "RankingList{" + "female=" + female + ", male=" + male + "} " + super.toString();
    }
