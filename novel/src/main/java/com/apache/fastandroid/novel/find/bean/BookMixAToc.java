...
public class BookMixAToc extends Base {
    ...
    public String toString() {
        return "BookMixAToc{" + "mixToc=" + mixToc + "} " + super.toString();
    }
    ...
    public static class mixToc implements Serializable {
        ...
        @Override
        public String toString() {
            return "mixToc{" + "_id='" + _id + '\'' + ", book='" + book + '\'' + ", chaptersUpdated='" +
                    chaptersUpdated + '\'' + ", chapters=" + chapters + '}';
        }
        ...
        public static class Chapters implements Serializable {
            ...
            @Override
            public String toString() {
                return "Chapters{" + "title='" + title + '\'' + ", link='" + link + '\'' + ", id='" + id + '\'' + ", " +
                        "currency=" + currency + ", unreadble=" + unreadble + ", isVip=" + isVip + '}';
            }
        }
    }
