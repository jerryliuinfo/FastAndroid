...
public class BookSelfFragmentV2 extends ARecycleViewSwipeRefreshFragment<RecommendBook,RecommandBeans,RecommendBook> implements ATabsFragment.ITabInitData {
    public static void launch(Activity from) {
        FragmentArgs args =  new FragmentArgs();
        FragmentContainerActivity.launch(from,BookSelfFragmentV2.class,args);
    }
    public static BookSelfFragmentV2 newFragment() {
        BookSelfFragmentV2 fragment = new BookSelfFragmentV2();
