 ...
 */
package com.apache.fastandroid.novel.view.readview;
...
public class PageFactory {
    ...
    public PageFactory(Context context, int width, int height, int fontSize, String bookId,
        ...
        mTitlePaint.setColor(ContextCompat.getColor(FrameworkApplication.getContext(), R.color.chapter_title_day));
    ...
    public File getBookFile(int chapter) {
        ...
        if (file != null && file.length() > 10) {
            // 解决空文件造成编码错误的问题
            charset = ChapterFileUtil.getCharset(file.getAbsolutePath());
        }
        NovelLog.i("charset=" + charset);
        return file;
    }
