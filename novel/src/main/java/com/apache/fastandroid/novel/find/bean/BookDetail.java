...
public class BookDetail implements Serializable {
    ...
    public String toString() {
        return "BookDetail{" + "_id='" + _id + '\'' + ", author='" + author + '\'' + ", banned=" + banned + ", " +
                "cover='" + cover + '\'' + ", creater='" + creater + '\'' + ", dramaPoint=" + dramaPoint + ", " +
                "followerCount=" + followerCount + ", gradeCount=" + gradeCount + ", isSerial=" + isSerial + ", " +
                "lastChapter='" + lastChapter + '\'' + ", latelyFollower=" + latelyFollower + ", longIntro='" +
                longIntro + '\'' + ", postCount=" + postCount + '}';
    }
}
