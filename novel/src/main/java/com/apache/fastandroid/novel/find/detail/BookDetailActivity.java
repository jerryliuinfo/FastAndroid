...
import com.apache.fastandroid.novel.support.util.FormatUtils;
...
public class BookDetailActivity extends BaseActivity {
    ...
    private void updateHeader(BookDetail data){
        ...
        tvWordCount.setText(FormatUtils.formatWordCount(data.wordCount));
        tvLatelyUpdate.setText(FormatUtils.getDescriptionTimeFromDateString(data.updated));
