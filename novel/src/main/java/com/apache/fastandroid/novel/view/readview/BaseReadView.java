...
import com.apache.fastandroid.novel.support.mananger.ThemeManager;
...
public abstract class BaseReadView extends View {
    ...
    public BaseReadView(Context context, String bookId, List<BookMixAToc.mixToc.Chapters> chaptersList,
        ...
        pagefactory = new PageFactory(mContext, bookId, chaptersList);
    ...
    public synchronized void init(int theme) {
        if (!isPrepared) {
            try {
                ...
                NovelLog.i("上次阅读位置：chapter=" + pos[0] + " startPos=" + pos[1] + " endPos=" + pos[2]);
                if (ret == 0) {
