...
package com.apache.fastandroid.news.bean;
...
public class NewsBean implements Serializable {
    ...
    public String toString() {
        return "NewsBean{" + "id=" + id + ", title='" + title + '\'' + ", created_at='" + created_at + '\'' + ", " +
                "updated_at='" + updated_at + '\'' + ", user=" + user + ", node_name='" + node_name + '\'' + ", " +
                "node_id=" + node_id + ", last_reply_user_id=" + last_reply_user_id + ", last_reply_user_login='" +
                last_reply_user_login + '\'' + ", replied_at='" + replied_at + '\'' + ", replies_count=" +
                replies_count + ", address='" + address + '\'' + '}';
    }
}
