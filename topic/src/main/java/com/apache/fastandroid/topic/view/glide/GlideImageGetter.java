...
package com.apache.fastandroid.topic.view.glide;
...
public final class GlideImageGetter implements Html.ImageGetter, Drawable.Callback {
    ...
    public Drawable getDrawable(String url) {
        ...
        TopicLogUtil.i("Downloading from: " + url);
        Glide.with(mContext)
                .load(url)
    ...
    private class ImageGetterViewTarget extends ViewTarget<TextView, GlideDrawable> {
        ...
        public void onResourceReady(GlideDrawable resource, GlideAnimation<? super GlideDrawable> glideAnimation) {
            ...
            if (resource.getIntrinsicWidth() > 100) {
                float width;
                float height;
                TopicLogUtil.i("Image width is " + resource.getIntrinsicWidth());
                TopicLogUtil.i("View width is " + view.getWidth());
                ...
                TopicLogUtil.i("New Image width is " + width);
