...
import com.apache.fastandroid.demo.hawk.XHawkBuilder;
...
public class DefaultHawkFacade implements HawkFacade {
  ...
  public DefaultHawkFacade(XHawkBuilder builder) {
    encryption = builder.getEncryption();
    storage = builder.getStorage();
    converter = builder.getConveter();
    serializer = builder.getSerialize();
