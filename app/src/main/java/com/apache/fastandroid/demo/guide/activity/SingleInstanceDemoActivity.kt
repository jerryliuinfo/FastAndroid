 ...
 */
class SingleInstanceDemoActivity:BaseVBActivity<ActivityLaunchmodeSingleinstanceBinding>(ActivityLaunchmodeSingleinstanceBinding::inflate){
    ...
    override fun onNewIntent(intent: Intent?) {
        ...
        Logger.d("SingleInstanceDemoActivity onNewIntent ")
    }
}