 ...
 */
public class AliPay implements XPayStrategy<AlipayInfoImpli> {

    private static final int SDK_PAY_FLAG = 6406;
    private Activity mActivity;
    private AlipayInfoImpli alipayInfoImpli;
    private static XPayCallback sPayCallback;
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, AlipayResultCode.CODE_SUCCESS)) {
                        ...
                        if (sPayCallback != null) {
                            sPayCallback.failed(AlipayResultCode.getIntCodeByString(resultStatus), AlipayResultCode.getTextByCode(resultStatus));
                        }
                    }
                    break;
                }
    ...
    @Override
    public void pay(@NonNull Activity activity, @NonNull AlipayInfoImpli payInfo, @NonNull XPayCallback callback) {
