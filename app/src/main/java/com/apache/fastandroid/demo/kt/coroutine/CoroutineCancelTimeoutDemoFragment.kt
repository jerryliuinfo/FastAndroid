...
class CoroutineCancelTimeoutDemoFragment :
    ...
    override fun layoutInit(inflater: LayoutInflater?, savedInstanceState: Bundle?) {
        ...
        mBinding.btnJobIsCooperation.setOnClickListener {
            cancelIsCooperation()
        }
        mBinding.btnMakeCalculateCancable.setOnClickListener {
            makeCalculateCancable()
        }
        ...
        mBinding.btnAsyncTimeoutResource.setOnClickListener {
