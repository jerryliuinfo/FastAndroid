...
class LoadSirActivityEmptyFragment:BaseBindingFragment<LoadsirActivityEmptyBinding>(LoadsirActivityEmptyBinding::inflate) {
    ...
    override fun layoutInit(inflater: LayoutInflater?, savedInstanceState: Bundle?) {
        ...
        }).setCallBack(com.apache.fastandroid.demo.component.loadsir.sample.callback.EmptyCallback::class.java,object :Transport{
       ...
       /* HandlerUtil.getUIHandler().postDelayed({
        ...
        runOnUIDelay({
            loadService.showCallback(com.apache.fastandroid.demo.component.loadsir.sample.callback.EmptyCallback::class.java)
        },1000)
    }
