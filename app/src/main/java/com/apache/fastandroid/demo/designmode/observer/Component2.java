 ...
 */
public class Component2 implements IControlComponent {
    public static final String OBSEVER_MODE_TAG = "observer";
    @Override
    public void onPlayStateChanged(int playState) {
        NLog.d(OBSEVER_MODE_TAG, "Component2 onPlayStateChanged playState: %s",playState);
    }

    @Override
    public void attach(ControlWrapper mControlWrapper) {
        NLog.d(OBSEVER_MODE_TAG, "Component2 attach");
    }
}
