...
fun renderParentLink(activity: ComponentActivity): String {
    return activity.getString(R.string.go_parent_label)
}

fun renderItem(activity: ComponentActivity, file: File): String {
...
fun openFile(activity: ComponentActivity, selectedItem: File) {
