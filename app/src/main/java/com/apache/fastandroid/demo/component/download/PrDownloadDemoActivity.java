...
package com.apache.fastandroid.demo.component.download;
...
public class PrDownloadDemoActivity extends AppCompatActivity {

    private static String dirPath;

    final String URL1 = "https://fs-im-kefu.7moor-fs1.com/29397395/4d2c3f00-7d4c-11e5-af15-41bf63ae4ea0/1694907359378/协程分享.xmind";
    final String URL2 = "https://fs-im-kefu.7moor-fs1.com/29397395/4d2c3f00-7d4c-11e5-af15-41bf63ae4ea0/1694907902655/farfield_close.jpeg";
                ...
                downloadIdThree = PRDownloader.download(URL3, dirPath, "instagram.apk")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressThree.setText(getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdFour = PRDownloader.download(URL4, dirPath, "flashlight.apk")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressFour.setText(getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdFive = PRDownloader.download(URL5, dirPath, "screenrecorder.apk")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressFive.setText(getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdSix = PRDownloader.download(URL6, dirPath, "callrecorder.apk")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressSix.setText(getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdSeven = PRDownloader.download(URL7, dirPath, "soundprofile.apk")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressSeven.setText(getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdEight = PRDownloader.download(URL8, dirPath, "evernote.apk")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressEight.setText(getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdNine = PRDownloader.download(URL9, dirPath, "ucbrowser.apk")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressNine.setText(getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdTen = PRDownloader.download(URL10, dirPath, "barcodescanner.apk")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressTen.setText(getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdEleven = PRDownloader.download(URL11, dirPath, "BigBuckBunny.m4v")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressEleven.setText(getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdTwelve = PRDownloader.download(URL12, dirPath, "harry-porter.pdf")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressTwelve.setText(getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdThirteen = PRDownloader.download(URL13, dirPath, "giphy.gif")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressThirteen.setText(getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdFourteen = PRDownloader.download(URL14, dirPath, "small.mp4")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressFourteen.setText(getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
                ...
                downloadIdFifteen = PRDownloader.download(URL15, dirPath, "big_buck_bunny_720p_10mb.mp4")
                        ...
                        .setOnProgressListener(new OnProgressListener() {
                            ...
                            public void onProgress(Progress progress) {
                                ...
                                textViewProgressFifteen.setText(getProgressDisplayLine(progress.currentBytes, progress.totalBytes));
                            }
                        })
                        .start(new OnDownloadListener() {
                            @Override
