...
public class TopicContent implements Serializable {
    ...
    public String toString() {
        return "TopicContent{" + "id=" + id + ", title='" + title + '\'' + ", created_at='" + created_at + '\'' + ", " +
                ...
                + ", deleted=" + deleted + ", excellent=" + excellent + ", abilities=" + abilities + ", body='" +
                body + '\'' + ", body_html='" + body_html + '\'' + ", hits=" + hits + ", likes_count=" + likes_count
                + ", suggested_at='" + suggested_at + '\'' + ", followed=" + followed + ", liked=" + liked + ", " +
                "favorited=" + favorited + '}';
    }
}