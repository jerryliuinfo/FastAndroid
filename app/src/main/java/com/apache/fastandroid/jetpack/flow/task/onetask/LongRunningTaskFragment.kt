 ...
 */
class LongRunningTaskFragment:BaseBindingFragment<FragmentCompletionBinding>(FragmentCompletionBinding::inflate) {

    private val viewModel:LongRunningTaskViewModel by viewModels { getViewModelFactory() }
