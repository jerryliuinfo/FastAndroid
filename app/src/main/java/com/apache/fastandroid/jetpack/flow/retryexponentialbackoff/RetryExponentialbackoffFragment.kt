package com.apache.fastandroid.jetpack.flow.retryexponentialbackoff
 ...
 */
class RetryExponentialbackoffFragment: BaseBindingFragment<FragmentCompletionBinding>(FragmentCompletionBinding::inflate) {

    private val viewModel: RetryExponentialBackoffModel by viewModels{getFlowViewModelFactory()}
