...
class RepoRepository constructor(
    ...
    companion object{
        ...
        fun getInstance(appExecutors: AppExecutors,db: GithubDb,repoDao: RepoDao,githubService: GithubService):RepoRepository{
            return sInstance ?: synchronized(this){
                sInstance ?:RepoRepository(appExecutors,db,repoDao,githubService).also {
                    sInstance = it
                }
            }
        }
