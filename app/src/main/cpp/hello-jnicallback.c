...
Java_com_apache_fastandroid_demo_jni_JniCCallJavaDemoFragment_stringFromJNI( JNIEnv* env, jobject thiz )
{
#if defined(__arm__)
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    //com.apache.fastandroid.demo.jni.JniHandler
...
//com.apache.fastandroid.demo.jni
Java_com_apache_fastandroid_demo_jni_JniCCallJavaDemoFragment_startTicks(JNIEnv *env, jobject instance) {
...
Java_com_apache_fastandroid_demo_jni_JniCCallJavaDemoFragment_StopTicks(JNIEnv *env, jobject instance) {
