...
package com.tesla.framework.ui.widget.round.helper;
...
public class RoundHelper {
    ...
    public void initAttrs(Context context, AttributeSet attrs) {
        ...
        if (roundCornerTopLeft == 0 && roundCornerTopRight == 0 && roundCornerBottomLeft == 0 && roundCornerBottomRight == 0){
            roundCornerTopLeft = roundCornerTopRight =  roundCornerBottomRight = roundCornerBottomLeft = roundCorner;
        }
