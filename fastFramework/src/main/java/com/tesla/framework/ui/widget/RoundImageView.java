...
public class RoundImageView extends AppCompatImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderColor = a.getColor(R.styleable.RoundImageView_round_border_color, Color.WHITE);
        mBorderWidth = a.getDimension(R.styleable.RoundImageView_round_border_width, 0);
