...
import com.tesla.framework.component.crashreporter.adapter.CrashLogAdapter;
...
public class ExceptionLogFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.crash_report_exception_log, container, false);
