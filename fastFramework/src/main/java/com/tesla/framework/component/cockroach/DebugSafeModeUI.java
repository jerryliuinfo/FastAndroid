...
import com.tesla.framework.common.util.FullActivityLifecycleCallbacksAdapter;
...
public class DebugSafeModeUI {
    ...
    public static void init(Application application) {
        application.registerActivityLifecycleCallbacks(new FullActivityLifecycleCallbacksAdapter() {
            @Override
