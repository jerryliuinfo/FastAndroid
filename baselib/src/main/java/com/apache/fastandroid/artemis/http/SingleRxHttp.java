...
import com.apache.fastandroid.artemis.http.interceptor.HeaderInterceptor;
...
/**
 * 网络请求-----可以对每个请求单独配置参数
 * 1. 当单独请求中设置了参数，则使用单独请求的参数
 * 2. 如果单独请求中没有设置参数，则启用全局的参数
 */
...
public class SingleRxHttp {
     ...
     * @return SingleRxHttp
     */
    public static SingleRxHttp newInstance() {
    ...
    /**
     * 单个RetrofitBuilder, 如果单独请求中有配置个性化参数，则以个性化参数为准，否则以全局http参数为准
     *
     * @return
     */
    ...
    /**
     * 获取单个 OkHttpClient.Builder,做个性化配置
     *
     * @return
     */
